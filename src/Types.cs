...
namespace Orbbec
{
    ...
    public enum PropertyId
    {
        ...
        OB_DEVICE_PROPERTY_DISPARITY_TO_DEPTH_BOOL = 85,  // 视差转深度开关， 0：关闭，深度流输出视差图； 1. 打开，深度流输出深度图。
        ...
        OB_RAW_DATA_DEPTH_CALIB_PARA = 4026,  // 深度标定参数(MX6600, read only)
        OB_RAW_DATA_ALIGN_CALIB_PARA = 4027,  // 对齐标定参数(MX6600, read only)
        ...
        OB_DEVICE_DEBUG_SENSOR_EXPOSURE_TIME = 5504,  // 曝光时间读写 // 结构体
    }
}