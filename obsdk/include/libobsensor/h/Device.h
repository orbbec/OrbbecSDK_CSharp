 ...
 * @brief Device synchronization: including exposure synchronization function and multi-camera synchronization function of different sensors within a single machine
 *
 * @param[in] device Device object
 * @param[out] error Log error messages
 ...
 *
 * @attention Calling this function will directly write the configuration to the device Flash, and it will still take effect after the device restarts. To avoid affecting the Flash lifespan, do not update the configuration frequently.
 *
 * @param[in] device Device object
